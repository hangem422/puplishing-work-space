import { createElementNSWithOption, appendAllChild } from './util/dom';
...
export function emptyAlarmImage(size = 200) {
  ...
  const svg = createElementNSWithOption(xmlns, 'svg', {
    xmlns,
    width: size.toString(),
    height: size.toString(),
    viewBox: '0 0 200 200',
  });
  const wrapper = createElementNSWithOption(xmlns, 'g', {
    fill: 'none',
    'fill-rule': 'evenodd',
  });

  const p1 = createElementNSWithOption(xmlns, 'path', {
    fill: '#F2F2F2',
    'fill-rule': 'nonzero',
    d:
  ...
  const p2 = createElementNSWithOption(xmlns, 'g', {
    fill: '#E0E0E0',
    'fill-rule': 'nonzero',
  });
  const p2c1 = createElementNSWithOption(xmlns, 'path', {
    d:
  ...
  const p3 = createElementNSWithOption(xmlns, 'g', {
    fill: '#E0E0E0',
    'fill-rule': 'nonzero',
  });
  const p3c1 = createElementNSWithOption(xmlns, 'path', {
    d:
  ...
  const p4 = createElementNSWithOption(xmlns, 'g', {
    fill: '#E0E0E0',
    'fill-rule': 'nonzero',
  });
  const p4c1 = createElementNSWithOption(xmlns, 'path', {
    d:
  ...
  const p5 = createElementNSWithOption(xmlns, 'path', {
    fill: '#F2F2F2',
    'fill-rule': 'nonzero',
    d:
  ...
  const p6 = createElementNSWithOption(xmlns, 'path', {
    fill: '#B0B0B0',
    'fill-rule': 'nonzero',
    d:
  ...
  const p7 = createElementNSWithOption(xmlns, 'path', {
    fill: '#F7F7F7',
    'fill-rule': 'nonzero',
    d:
  ...
  const p8 = createElementNSWithOption(xmlns, 'rect', {
    width: '68',
    height: '6',
    x: '95',
    y: '75',
  ...
  const p9 = createElementNSWithOption(xmlns, 'rect', {
    width: '68',
    height: '6',
    x: '95',
    y: '89',
  ...
  const p10 = createElementNSWithOption(xmlns, 'rect', {
    width: '68',
    height: '6',
    x: '95',
    y: '103',
  ...
  const p11 = createElementNSWithOption(xmlns, 'circle', {
    cx: '54.05',
    cy: '92.46',
    r: '25',
    fill: '#E5E5E5',
  ...
  const p12 = createElementNSWithOption(xmlns, 'path', {
    fill: '#FFF',
    d:
